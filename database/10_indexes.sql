...
-- Impression analytics datastore: fact table indexes (support advertiser/campaign/device/location insights)
...
-- Impression daily rollups: fast lookups for dashboards
